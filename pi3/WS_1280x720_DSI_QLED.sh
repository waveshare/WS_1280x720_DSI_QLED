...
#Move driver file
sudo cp WS_1280x720_DSI_QLED_Touch.ko /lib/modules/$(uname -r)
sudo cp WS_1280x720_DSI_QLED_Screen.ko /lib/modules/$(uname -r)
sudo cp WS_1280x720_DSI_QLED_Touch.dtbo /boot/overlays
sudo cp WS_1280x720_DSI_QLED_Screen.dtbo /boot/overlays
...
#Install driver
sudo depmod
sudo modprobe WS_1280x720_DSI_QLED_Touch
sudo modprobe WS_1280x720_DSI_QLED_Screen
...
Data_Insertion config.txt  "dtoverlay=WS_1280x720_DSI_QLED_Screen"
#Data_Insertion config.txt  "# -------------touch---------------"
Data_Insertion config.txt  "dtparam=i2c_vc=on"
Data_Insertion config.txt  "dtoverlay=WS_1280x720_DSI_QLED_Touch"
