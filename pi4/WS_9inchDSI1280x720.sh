...
#Move driver file
sudo cp WS_9inchDSI1280x720_Touch.ko /lib/modules/$(uname -r)
sudo cp WS_9inchDSI1280x720_Screen.ko /lib/modules/$(uname -r)
sudo cp WS_9inchDSI1280x720_Touch.dtbo /boot/overlays
sudo cp WS_9inchDSI1280x720_Screen.dtbo /boot/overlays
...
#Install driver
sudo depmod
sudo modprobe WS_9inchDSI1280x720_Touch
sudo modprobe WS_9inchDSI1280x720_Screen
...
Data_Insertion config.txt  "dtoverlay=WS_9inchDSI1280x720_Screen"
#Data_Insertion config.txt  "# -------------touch---------------"
Data_Insertion config.txt  "dtparam=i2c_vc=on"
Data_Insertion config.txt  "dtoverlay=WS_9inchDSI1280x720_Touch"
